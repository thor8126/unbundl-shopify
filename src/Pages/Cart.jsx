    ...
    <>
      <div className="h-screen pt-20">
        ...
        <div className="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0">
            ...
            <div className="sm:max-h-96 overflow-y-auto">
              {selectedChocolates.map((selectedChocolate) => (
                <div
                  ...
                  className="justify-between mb-6 rounded-lg bg-gray-300 p-6 shadow-md sm:flex sm:justify-start"
                >
                  <img
          ...
          <div className="mt-6 h-full rounded-lg border p-6 shadow-md md:mt-0 md:w-1/3 text-white">
            ...
            <Link to="/checkout" className="btn mt-6 w-full rounded-md bg-blue-500 py-1.5 font-medium text-blue-50 hover:bg-blue-600">
              Check out
            </Link>
          </div>
        </div>
